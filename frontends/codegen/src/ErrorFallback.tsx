    ...
    <div className={
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-card border rounded-lg p-4 mb-6">
          <h3 className={
            "font-semibold text-sm text-muted-foreground mb-2"
          }>Error Details:</h3>
          <pre className={
            "text-xs text-destructive bg-muted/50 p-3"
            + " rounded border overflow-auto max-h-32"
          }>
            {error.message}
          </pre>
          {error.stack && (
            <pre className={
              ...
              + " rounded border overflow-auto max-h-48 mt-2"
            }>
              {error.stack}
            </pre>
          )}
