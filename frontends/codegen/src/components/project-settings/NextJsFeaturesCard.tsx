    ...
    <Card>
      ...
      <CardContent>
        <div className="ps-switch-list">
          {[
            { id: 'typescript', key: 'typescript' as const,
              item: features.items.typescript },
            { id: 'eslint', key: 'eslint' as const,
              item: features.items.eslint },
            { id: 'tailwind', key: 'tailwind' as const,
              item: features.items.tailwind },
            { id: 'src-dir', key: 'srcDirectory' as const,
              item: features.items.srcDirectory },
            { id: 'app-router', key: 'appRouter' as const,
              item: features.items.appRouter },
            { id: 'turbopack', key: 'turbopack' as const,
              item: features.items.turbopack },
          ].map(({ id, key, item }) => (
