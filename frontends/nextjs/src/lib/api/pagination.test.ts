...
describe('pagination utilities', () => {
  describe('normalizePaginationParams', () => {
    it.each([
      ...
      {
        input: { page: 3, limit: 30 },
        expected: { page: 3, limit: 30 },
        description: 'custom page and limit',
      },
      {
        input: { page: 0 },
        expected: { page: 1, limit: 20 },
        description: 'negative page to 1',
      },
      {
        input: { page: -5 },
        expected: { page: 1, limit: 20 },
      ...
      },
      {
        ...
        description: 'zero limit to 1',
      },
      {
        input: { limit: -10 },
        expected: { page: 1, limit: 1 },
        description: 'negative limit to 1',
      },
      {
        input: { limit: 200 },
        expected: { page: 1, limit: 100 },
        description: 'limit capped at 100',
      },
  ...
  describe('calculatePaginationMetadata', () => {
    it.each([
      ...
      'should calculate metadata for $description',
  ...
  describe('calculateOffset', () => {
    it.each([
      ...
      { page: 2, limit: 20, expected: 20, description: 'second page' },
      {
        ...
        limit: 10,
        expected: 20,
        description: 'third page with limit 10',
      },
      {
        page: 5,
        limit: 25,
        expected: 100,
        description: 'fifth page with limit 25',
      },
    ])(
      'should calculate offset for $description',
      ({ page, limit, expected }) => {
  ...
  describe('normalizeCursorPaginationParams', () => {
    it.each([
      {
        input: {},
        expected: { limit: 20, after: undefined, before: undefined },
        description: 'default values',
      },
      {
        input: { limit: 50 },
        expected: { limit: 50, after: undefined, before: undefined },
        description: 'custom limit',
      },
      {
        input: { after: 'cursor1' },
        expected: { limit: 20, after: 'cursor1', before: undefined },
        description: 'with after cursor',
      },
      {
        input: { before: 'cursor2' },
        expected: { limit: 20, after: undefined, before: 'cursor2' },
        description: 'with before cursor',
      },
      {
        input: { limit: 200 },
        expected: { limit: 100, after: undefined, before: undefined },
        description: 'limit capped at 100',
      },
    ])(
      'should normalize cursor params for $description',
      ({ input, expected }) => {
  ...
  describe('getPageNumbers', () => {
    it.each([
      ...
      },
      {
        ...
        totalPages: 3,
        expected: [1, 2, 3],
        description: 'few pages',
      },
    ])(
      'should get page numbers for $description',
