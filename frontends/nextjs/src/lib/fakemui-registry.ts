...
export const FAKEMUI_REGISTRY: Record<string, ComponentType<any>> = {
  ...
  Fade: lazyComponent(() => import('@/fakemui/fakemui/utils').then(m => ({ default: m.Fade }))),
  Grow: lazyComponent(() => import('@/fakemui/fakemui/utils').then(m => ({ default: m.Grow }))),
  Slide: lazyComponent(() => import('@/fakemui/fakemui/utils').then(m => ({ default: m.Slide }))),
  Zoom: lazyComponent(() => import('@/fakemui/fakemui/utils').then(m => ({ default: m.Zoom }))),
  Collapse: lazyComponent(() => import('@/fakemui/fakemui/utils').then(m => ({ default: m.Collapse }))),

  // Atoms (9)
  Text: lazyComponent(() => import('@/fakemui/fakemui/atoms').then(m => ({ default: m.Text }))),
  Title: lazyComponent(() => import('@/fakemui/fakemui/atoms').then(m => ({ default: m.Title }))),
  Label: lazyComponent(() => import('@/fakemui/fakemui/atoms').then(m => ({ default: m.Label }))),
  Panel: lazyComponent(() => import('@/fakemui/fakemui/atoms').then(m => ({ default: m.Panel }))),
  Section: lazyComponent(() => import('@/fakemui/fakemui/atoms').then(m => ({ default: m.Section }))),
  StatBadge: lazyComponent(() => import('@/fakemui/fakemui/atoms').then(m => ({ default: m.StatBadge }))),
  States: lazyComponent(() => import('@/fakemui/fakemui/atoms').then(m => ({ default: m.States }))),
  EditorWrapper: lazyComponent(() => import('@/fakemui/fakemui/atoms').then(m => ({ default: m.EditorWrapper }))),
  AutoGrid: lazyComponent(() => import('@/fakemui/fakemui/atoms').then(m => ({ default: m.AutoGrid }))),

  // Lab / Experimental (11)
  LoadingButton: lazyComponent(() => import('@/fakemui/fakemui/lab').then(m => ({ default: m.LoadingButton }))),
  Masonry: lazyComponent(() => import('@/fakemui/fakemui/lab').then(m => ({ default: m.Masonry }))),
  Timeline: lazyComponent(() => import('@/fakemui/fakemui/lab').then(m => ({ default: m.Timeline }))),
  TimelineItem: lazyComponent(() => import('@/fakemui/fakemui/lab').then(m => ({ default: m.TimelineItem }))),
  TimelineSeparator: lazyComponent(() => import('@/fakemui/fakemui/lab').then(m => ({ default: m.TimelineSeparator }))),
  TimelineDot: lazyComponent(() => import('@/fakemui/fakemui/lab').then(m => ({ default: m.TimelineDot }))),
  TimelineConnector: lazyComponent(() => import('@/fakemui/fakemui/lab').then(m => ({ default: m.TimelineConnector }))),
  TimelineContent: lazyComponent(() => import('@/fakemui/fakemui/lab').then(m => ({ default: m.TimelineContent }))),
  TimelineOppositeContent: lazyComponent(() => import('@/fakemui/fakemui/lab').then(m => ({ default: m.TimelineOppositeContent }))),
  TreeView: lazyComponent(() => import('@/fakemui/fakemui/lab').then(m => ({ default: m.TreeView }))),
  TreeItem: lazyComponent(() => import('@/fakemui/fakemui/lab').then(m => ({ default: m.TreeItem }))),

  // X / Advanced (1)
  DataGrid: lazyComponent(() => import('@/fakemui/fakemui/x').then(m => ({ default: m.DataGrid }))),

  // Icons (30+)
  Icon: lazyComponent(() => import('@/fakemui/icons').then(m => ({ default: m.Icon }))),
  Plus: lazyComponent(() => import('@/fakemui/icons').then(m => ({ default: m.Plus }))),
  Trash: lazyComponent(() => import('@/fakemui/icons').then(m => ({ default: m.Trash }))),
  Copy: lazyComponent(() => import('@/fakemui/icons').then(m => ({ default: m.Copy }))),
  Check: lazyComponent(() => import('@/fakemui/icons').then(m => ({ default: m.Check }))),
  X: lazyComponent(() => import('@/fakemui/icons').then(m => ({ default: m.X }))),
  Filter: lazyComponent(() => import('@/fakemui/icons').then(m => ({ default: m.Filter }))),
  FilterOff: lazyComponent(() => import('@/fakemui/icons').then(m => ({ default: m.FilterOff }))),
  ArrowUp: lazyComponent(() => import('@/fakemui/icons').then(m => ({ default: m.ArrowUp }))),
  ArrowDown: lazyComponent(() => import('@/fakemui/icons').then(m => ({ default: m.ArrowDown }))),
  ArrowClockwise: lazyComponent(() => import('@/fakemui/icons').then(m => ({ default: m.ArrowClockwise }))),
  ChevronUp: lazyComponent(() => import('@/fakemui/icons').then(m => ({ default: m.ChevronUp }))),
  ChevronDown: lazyComponent(() => import('@/fakemui/icons').then(m => ({ default: m.ChevronDown }))),
  ChevronLeft: lazyComponent(() => import('@/fakemui/icons').then(m => ({ default: m.ChevronLeft }))),
  ChevronRight: lazyComponent(() => import('@/fakemui/icons').then(m => ({ default: m.ChevronRight }))),
  FloppyDisk: lazyComponent(() => import('@/fakemui/icons').then(m => ({ default: m.FloppyDisk }))),
  Search: lazyComponent(() => import('@/fakemui/icons').then(m => ({ default: m.Search }))),
  Settings: lazyComponent(() => import('@/fakemui/icons').then(m => ({ default: m.Settings }))),
  User: lazyComponent(() => import('@/fakemui/icons').then(m => ({ default: m.User }))),
  UserCheck: lazyComponent(() => import('@/fakemui/icons').then(m => ({ default: m.UserCheck }))),
  Eye: lazyComponent(() => import('@/fakemui/icons').then(m => ({ default: m.Eye }))),
  EyeSlash: lazyComponent(() => import('@/fakemui/icons').then(m => ({ default: m.EyeSlash }))),
  Pencil: lazyComponent(() => import('@/fakemui/icons').then(m => ({ default: m.Pencil }))),
  Calendar: lazyComponent(() => import('@/fakemui/icons').then(m => ({ default: m.Calendar }))),
  Clock: lazyComponent(() => import('@/fakemui/icons').then(m => ({ default: m.Clock }))),
  Mail: lazyComponent(() => import('@/fakemui/icons').then(m => ({ default: m.Mail }))),
  Bell: lazyComponent(() => import('@/fakemui/icons').then(m => ({ default: m.Bell }))),
  Star: lazyComponent(() => import('@/fakemui/icons').then(m => ({ default: m.Star }))),
  Heart: lazyComponent(() => import('@/fakemui/icons').then(m => ({ default: m.Heart }))),
  Share: lazyComponent(() => import('@/fakemui/icons').then(m => ({ default: m.Share }))),
  MenuIcon: lazyComponent(() => import('@/fakemui/icons').then(m => ({ default: m.Menu }))),
}
