...
describe('auth-middleware', () => {
  ...
  describe('authenticate', () => {
    describe('public access', () => {
      it.each([
        {
          name: 'allows public access when allowPublic is true',
          allowPublic: true,
        },
      ...
      it.each([
        {
          ...
          minLevel: 0,
          shouldPass: true,
          name: 'public user accessing public endpoint',
        },
        {
          userLevel: 1,
          minLevel: 0,
          shouldPass: true,
          name: 'user accessing public endpoint',
        },
        {
          userLevel: 1,
          minLevel: 1,
        ...
        },
        {
          ...
          minLevel: 1,
          shouldPass: true,
          name: 'moderator accessing user endpoint',
        },
        {
          userLevel: 3,
          minLevel: 3,
        ...
        },
        {
          ...
          minLevel: 3,
          shouldPass: true,
          name: 'god accessing admin endpoint',
        },
        {
          userLevel: 5,
          minLevel: 5,
          shouldPass: true,
          name: 'supergod accessing supergod endpoint',
        },
        {
          userLevel: 0,
          minLevel: 1,
          shouldPass: false,
          name: 'public user accessing user endpoint',
        },
        {
          userLevel: 1,
          minLevel: 2,
          shouldPass: false,
          name: 'user accessing moderator endpoint',
        },
        {
          userLevel: 2,
          minLevel: 3,
          shouldPass: false,
          name: 'moderator accessing admin endpoint',
        },
        {
          userLevel: 3,
          minLevel: 4,
          shouldPass: false,
          name: 'admin accessing god endpoint',
        },
        {
          userLevel: 4,
          minLevel: 5,
          shouldPass: false,
          name: 'god accessing supergod endpoint',
        },
      ])(
        'should handle $name (level $userLevel, required $minLevel)',
        async ({ userLevel, minLevel, shouldPass }) => {
  ...
  describe('requireAuth', () => {
    ...
    it('should throw error response when authentication fails', async () => {
      ...
      await expect(requireAuth(request, { minLevel: 1 })).rejects.toBeDefined()
    })
    ...
    it('should throw error response when permission check fails', async () => {
      ...
      await expect(requireAuth(request, { minLevel: 3 })).rejects.toBeDefined()
    })
  })
})
