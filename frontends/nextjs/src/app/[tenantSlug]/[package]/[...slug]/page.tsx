          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            ...
            <tbody>
              {response.data !== undefined && response.data.length > 0 ? (
                (response.data as Record<string, unknown>[]).map(
                  (item, idx) => (
...
async function EntityDetailView({
  tenant,
  pkg,
  entity,
  id,
