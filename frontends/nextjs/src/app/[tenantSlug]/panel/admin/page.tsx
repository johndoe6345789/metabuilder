      ...
      .then((json: { data?: UserRecord[] } | null) => {
        if (json?.data != null) {
          ...
          setStats([
            ...
            {
              label: 'Admin Users',
              count: json.data.filter(
                u => u.role === 'admin' || u.role === 'god'
              ).length,
              icon: 'A',
            },
          ])
      ...
      <Paper className={s.tablePanel}>
        ...
        <TabPanel value={activeTab} index={2}>
          <Typography
            ...
            className={s.emptyState}
          >
            Entity schemas are loaded from DBAL at
            dbal/shared/api/schema/entities/. Connect to DBAL to browse
            entities.
          </Typography>
        </TabPanel>
      </Paper>
