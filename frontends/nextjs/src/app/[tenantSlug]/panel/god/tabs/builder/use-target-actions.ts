...
export function useTargetActions(
  t: Pick<ReturnType<typeof useComponentTree>, 'load' | 'loadedPath'>,
  tenant: string,
  ...
  // Where the tree came from is the tree's own record -- see
  // useComponentTree.loadedPath -- passed through for the setup panel.
  return { pick, change, load, loadedPath: t.loadedPath }
}
