        ...
        <aside className={s.list}>
          <div className={s.addRow}>
            <TextField
              size="small"
              label="New list"
              value={ui.newListName}
              onChange={e => {
                ui.setNewListName(e.target.value)
              }}
              onKeyDown={e => {
                if (e.key === 'Enter') addList()
              }}
            />
            <Button size="small" variant="contained" onClick={addList}>
              +
            </Button>
          </div>
          {dd.configs.map(c => (
          ...
          {selected ? (
            <>
              <TextField
                ...
                value={selected.name}
                onChange={e => {
                  dd.rename(selected.id, e.target.value)
                }}
              />
              ...
              <div className={s.addOpt}>
                ...
                <TextField
                  ...
                  value={ui.optValue}
                  onChange={e => {
                    ui.setOptValue(e.target.value)
                  }}
                  onKeyDown={e => {
                    if (e.key === 'Enter') addOpt()
                  }}
                />
                <Button size="small" variant="outlined" onClick={addOpt}>
                  Add
                </Button>
              </div>
            </>
      ...
      <div className={s.smtpSection}>
        <div className={s.smtpHead}>
          ...
          <Button
            variant="contained"
            size="small"
            disabled={!smtp.dirty || smtp.publishing}
            onClick={() => {
              void smtp.publish()
            }}
          >
        ...
        <div className={s.smtpGrid}>
          <TextField
            ...
            onChange={e => {
              smtp.set('host', e.target.value)
            }}
          />
          <TextField
            size="small"
            label="Port"
            value={String(smtp.config.port)}
            onChange={e => {
              smtp.set('port', Number(e.target.value) || 0)
            }}
          />
          <TextField
            size="small"
            ...
            onChange={e => {
              smtp.set('username', e.target.value)
            }}
          />
          <TextField
            size="small"
            ...
            onChange={e => {
              smtp.set('password', e.target.value)
            }}
          />
          <TextField
            size="small"
            label="From email"
            value={smtp.config.fromEmail}
            onChange={e => {
              smtp.set('fromEmail', e.target.value)
            }}
          />
          <TextField
            size="small"
            label="From name"
            value={smtp.config.fromName}
            onChange={e => {
              smtp.set('fromName', e.target.value)
            }}
          />
        </div>
      </div>
