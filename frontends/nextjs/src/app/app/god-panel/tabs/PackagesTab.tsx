...
export function PackagesTab() {
  ...
  const {
    isInstalled, installedRecord, install, uninstall, loading, error,
    ...
    <div className={s.root}>
      <div className={s.header}>
        ...
        <Typography variant="body2" color="text.secondary">
          Install features for a tenant.
          Each package adds pages and navigation instantly.
        </Typography>
      ...
      {flash !== null && (
        <Alert severity="info" onClose={() => { setFlash(null) }}>
          {flash}
        </Alert>
      )}
              ...
              <div className={s.foot}>
                {on ? (
                  <button
                    ...
                    disabled={isBusy}
                    onClick={() => { void handleUninstall(pkg.id) }}
                  >
                  ...
                  <button
                    ...
                    onClick={() => { void handleInstall(pkg.id) }}
                  >
