...
export function PageRoutesTab() {
  ...
  const handleDeleteClose = () => { setDeletePage(null) }
      ...
      <div className={s.header}>
        <div>
          ...
          <Typography variant="body2" color="text.secondary">
            Create and manage tenant pages. Each page maps a URL
            path to a component tree rendered at runtime.
          </Typography>
        </div>
      ...
      <div className={s.tenantRow}>
        ...
        {pages.length > 0 && (
          <>
            ...
            {draft > 0 && (
              <Chip label={`${draft} draft`} size="small" />
            )}
          </>
        )}
      </div>
