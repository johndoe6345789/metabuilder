...
import {
  CanvasNode, ConnectionLine, EditorToolbar, NodePalette, PropertiesDialog,
  NODE_CATEGORIES, NODE_TYPES, type NodeType, type Workflow,
...
export function WorkflowEditor({ workflow, onChange, onSave, onRun, onBack }: Props) {
  ...
  return (
    <div className={s.editor}>
      ...
      <PropertiesDialog
        ...
        nodeType={ed.selectedNode ? ed.getNodeType(ed.selectedNode.type) : undefined}
