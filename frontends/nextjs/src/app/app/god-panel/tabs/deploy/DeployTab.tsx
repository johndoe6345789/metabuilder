  ...
  return (
    <div className={s.root}>
      ...
      <div className={s.cards}>
        <div className={s.card}>
          ...
          <div className={s.cardBody}>
            ...
            <div className={s.cardDesc}>Download everything as a single JSON bundle.</div>
          </div>
          <Button variant="contained" size="small" disabled={d.busy}
            onClick={() => { void d.exportProject() }}>Export</Button>
        </div>
        ...
        <div className={s.card}>
          ...
          <div className={s.cardBody}>
            ...
            <div className={s.cardDesc}>Restore a project bundle (replaces local state).</div>
          </div>
          <Button variant="outlined" size="small" disabled={d.busy}
      ...
      <div className={s.env}>
        ...
        <div className={s.envRow}><span>DBAL API</span><code>{DBAL}</code></div>
        <div className={s.envRow}><span>Storage</span><code>IndexedDB → localStorage fallback</code></div>
      </div>
    </div>
  )
}
