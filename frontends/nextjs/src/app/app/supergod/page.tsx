...
function SuperGodContent() {
  ...
  return (
    <div className={s.root}>
      ...
      <TabPanel value={activeTab} index={0}><TenantsTab /></TabPanel>
      <TabPanel value={activeTab} index={1}><GodUsersTab /></TabPanel>
      <TabPanel value={activeTab} index={2}><PowerTransferTab /></TabPanel>
      <TabPanel value={activeTab} index={3}><PreviewLevelsTab /></TabPanel>
    </div>
  )
}
