...
function ProfileContent() {
  ...
  const joined = user?.createdAt != null
    ? new Intl.DateTimeFormat(undefined, { month: 'short', day: 'numeric', year: 'numeric' }).format(new Date(user.createdAt))
    : 'Not recorded'
  ...
  const [securityStatus, setSecurityStatus] = useState<'idle' | 'queued'>('idle')
      ...
      <header className={s.hero}>
        <div className={s.identity}>
          ...
          <div className={s.heroCopy}>
            ...
            <Typography variant="h4" className={s.title}>{username}</Typography>
            <div className={s.metaRow}>
              <span className={s.levelPill} style={{ borderColor: levelColor, color: levelColor }}>
                Level {roleLevel}
              </span>
        ...
        <div className={s.heroActions}>
          {!editing ? (
            <Button variant="contained" size="small" onClick={() => { setEditing(true); setStatus('idle') }}>
              Edit Profile
            </Button>
          ) : (
            <>
        ...
        <aside className={s.panel}>
          ...
          <div className={s.securityCard}>
            ...
            <div>
              ...
              <p>A new randomly generated password will be sent to your email address.</p>
            </div>
          </div>
          <Button variant="outlined" size="small" onClick={handlePasswordRequest} fullWidth>
