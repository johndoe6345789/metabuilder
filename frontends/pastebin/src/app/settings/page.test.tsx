...
jest.mock('@/components/demo/PersistenceSettings', () => ({
  PersistenceSettings: () => (
    <div data-testid="persistence-settings">Persistence</div>
  ),
}))
...
jest.mock('@/components/settings/BackendAutoConfigCard', () => ({
  BackendAutoConfigCard: () => (
    <div data-testid="backend-auto-config">Backend</div>
  ),
}))
...
describe('SettingsPage', () => {
  ...
  test('renders description text', () => {
    render(<SettingsPage />)
    expect(
      screen.getByText(/Manage your database and application settings/i),
    ).toBeInTheDocument()
  })
