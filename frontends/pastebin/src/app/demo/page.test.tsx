...
jest.mock('@/components/demo/DemoFeatureCards', () => ({
  DemoFeatureCards: () => (
    <div data-testid="demo-feature-cards">Feature Cards</div>
  ),
}))
...
describe('DemoPage', () => {
  ...
  test('renders demo description', () => {
    render(<DemoPage />)
    expect(
      screen.getByText(/live React component editing/i),
    ).toBeInTheDocument()
  })
  ...
  test('renders editor description', () => {
    render(<DemoPage />)
    expect(
      screen.getByText(/Code, Split, and Preview modes/i),
    ).toBeInTheDocument()
  })
  ...
  test('mentions JSX and TypeScript support', () => {
    render(<DemoPage />)
    expect(
      screen.getByText(/JSX, TSX, JavaScript, and TypeScript/i),
    ).toBeInTheDocument()
  })
