...
export const selectSnippetsLoading = (state: RootState) =>
  state.snippets.loading
export const selectSnippetsError = (state: RootState) =>
  state.snippets.error
export const selectSelectionMode = (state: RootState) =>
  state.snippets.selectionMode
export const selectSelectedIds = (state: RootState) =>
  state.snippets.selectedIds

export const selectNamespaces = (state: RootState) =>
  state.namespaces.items
export const selectSelectedNamespaceId = (state: RootState) =>
  state.namespaces.selectedId
export const selectNamespacesLoading = (state: RootState) =>
  state.namespaces.loading
export const selectNamespacesError = (state: RootState) =>
  state.namespaces.error

export const selectSearchQuery = (state: RootState) =>
  state.ui.searchQuery
export const selectViewerOpen = (state: RootState) =>
  state.ui.viewerOpen
export const selectViewingSnippet = (state: RootState) =>
  state.ui.viewingSnippet
...
export const selectSnippetComments = (
  state: RootState, snippetId: string
) => state.comments.snippetComments[snippetId] ?? []
export const selectProfileComments = (
  state: RootState, profileUserId: string
...
export const selectRevisionsLoading = (state: RootState) =>
  state.revisions.loading

export const selectSharedSnippet = (
  state: RootState, token: string
) => state.share.sharedSnippets[token] ?? null
export const selectShareLoading = (state: RootState) =>
  state.share.loading

export const selectUserProfile = (
  state: RootState, username: string
