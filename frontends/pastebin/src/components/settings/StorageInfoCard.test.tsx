...
describe('StorageInfoCard', () => {
  ...
  describe('state transitions', () => {
    ...
    it('should transition from localStorage to no storage', () => {
      const { rerender } = render(
        <StorageInfoCard storageType="localstorage" />,
      )
  ...
  describe('formatting and styling', () => {
    ...
    it('should wrap message in AlertDescription', () => {
      ...
      const alertDescription = container.querySelector(
  ...
  describe('all storage types coverage', () => {
    it('should handle all valid storage types', () => {
      const storageTypes: ('indexeddb' | 'localstorage' | 'none')[] = [
        'indexeddb',
        'localstorage',
        'none',
      ]
    ...
    it('should always render card structure', () => {
      // eslint-disable-next-line max-len
      const storageTypes: ('indexeddb' | 'localstorage' | 'none' | undefined)[] = ['indexeddb', 'localstorage', 'none', undefined]
  ...
  describe('accessibility', () => {
    it('should be readable by screen readers', () => {
      ...
      expect(screen.getByText(/Storage Information/i)).toBeInTheDocument()
      expect(screen.getByText(/How your data is stored/i)).toBeInTheDocument()
    })
