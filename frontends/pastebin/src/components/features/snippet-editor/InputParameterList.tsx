...
export function InputParameterList({
  ...
  return (
    <div className="space-y-16">
      <Card
        className={`${styles.cardRoot} bg-muted/30`}
        data-testid="input-parameters-card"
      >
        <CardHeader
          title={
            <h3
          ...
          <div className={styles.cardContent}>
            <div className={styles.functionNameField}>
              ...
              <p className={styles.helpText} id="function-name-help">
                The name of the function or component to render. Leave empty to
            ...
            {inputParameters.length > 0 && (
              <div
                className={styles.parametersList}
                role="region"
                aria-label="Input parameters list"
              >
                ...
                >
                  {inputParameters.length} parameter
                  {inputParameters.length !== 1 ? 's' : ''} configured
                </div>

                <FormLabel className={styles.parametersLabel}>
