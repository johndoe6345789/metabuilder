...
describe('TaskListsShowcase', () => {
  ...
  test('renders section description', () => {
    render(<TaskListsShowcase />)
    expect(
      screen.getByText(/Interactive lists with status and actions/i),
    ).toBeInTheDocument()
  })
  ...
  test('renders task descriptions', () => {
    render(<TaskListsShowcase />)
    expect(
      screen.getByText(/Complete the component library documentation/i),
    ).toBeInTheDocument()
    expect(
      screen.getByText(/Connect frontend to backend services/i),
    ).toBeInTheDocument()
