...
jest.mock('./showcases/NavigationBarsShowcase', () => ({
  ...
  NavigationBarsShowcase: ({ onSaveSnippet }: any) => (
    <div data-testid="navigation-bars-showcase">Navigation</div>
  ),
}))

jest.mock('./showcases/DataTablesShowcase', () => ({
  DataTablesShowcase: () => (
    <div data-testid="data-tables-showcase">Data Tables</div>
  ),
}))
...
jest.mock('./showcases/TaskListsShowcase', () => ({
  TaskListsShowcase: () => (
    <div data-testid="task-lists-showcase">Task Lists</div>
  ),
}))

jest.mock('./showcases/ContentGridsShowcase', () => ({
  ContentGridsShowcase: () => (
    <div data-testid="content-grids-showcase">Content Grids</div>
  ),
}))

jest.mock('./showcases/SidebarNavigationShowcase', () => ({
  SidebarNavigationShowcase: () => (
    <div data-testid="sidebar-navigation-showcase">Sidebar</div>
  ),
}))
