...
const FEATURES = [
  {
    icon: 'bar_chart', title: 'Analytics',
    desc: 'Track and analyze your product metrics in real-time',
  },
  {
    icon: 'group', title: 'Collaboration',
...
export function LandingHeroSection() {
  return (
    <div style={heroBg}>
      ...
      }}>Build Amazing Products Faster</h1>
      <p style={{
        fontSize: '1.25rem', lineHeight: '1.75rem',
        color: 'var(--mat-sys-on-surface-variant)',
        marginBottom: '32px', maxWidth: '672px', marginInline: 'auto',
      }}>
        The complete toolkit for modern product development. Ship
        faster with our component library and design system.
      </p>
      <div style={{
        display: 'flex', alignItems: 'center',
        ...
        <Button size="lg" variant="outlined">View Demo</Button>
      </div>
    </div>
  )
}
  ...
  return (
    <div style={{ padding: '48px' }}>
      <div style={{ textAlign: 'center', marginBottom: '48px' }}>
        ...
        <p style={{
          color: 'var(--mat-sys-on-surface-variant)',
          maxWidth: '672px', marginInline: 'auto',
        }}>
        ...
        {FEATURES.map(({ icon, title, desc }) => (
          <Card key={title} style={{ padding: '24px' }}>
            ...
            <h3 style={{
              ...
              lineHeight: '1.75rem', marginBottom: '8px',
            }}>{title}</h3>
            <p style={{
