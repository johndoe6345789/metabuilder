...
const pullquoteStyle = {
  ...
  marginBlock: '32px',
  backgroundColor:
    'color-mix(in srgb, var(--mat-sys-surface-variant) 50%, transparent)',
}
      ...
      <div style={{ padding: '32px' }}>
        <div style={{ maxWidth: '896px', marginInline: 'auto' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', marginBottom: '32px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
              ...
              <div>
                ...
                <p style={{ fontSize: '0.875rem', lineHeight: '1.25rem', color: onSurfaceVariant }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            <p style={{ fontSize: '1.125rem', lineHeight: 1.625, color: onSurfaceVariant }}>
              Design systems have become an essential part of modern product
              development. They provide consistency, improve efficiency, and
            ...
            <p style={{ color: onSurfaceVariant, lineHeight: 1.625 }}>
              The atomic design methodology consists of five distinct stages:
              atoms, molecules, organisms, templates, and pages. Each stage
              builds upon the previous, creating a comprehensive system that
              scales with your needs.
            </p>

            <Card style={pullquoteStyle}>
              <p style={{ fontSize: '0.875rem', lineHeight: '1.25rem', color: onSurfaceVariant, fontStyle: 'italic' }}>
                &ldquo;A design system is never complete. It&rsquo;s a living,
                breathing ecosystem that evolves with your product and team.&rdquo;
              </p>
            </Card>
            ...
            <p style={{ color: onSurfaceVariant, lineHeight: 1.625 }}>
              Begin by identifying the core components your product needs.
              Start small with basic atoms like buttons and inputs, then
              gradually build up to more complex organisms and templates.
            </p>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <Button variant="outlined">Previous Article</Button>
            <Button>
              Next Article
