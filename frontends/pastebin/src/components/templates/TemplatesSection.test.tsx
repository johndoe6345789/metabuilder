...
describe('TemplatesSection', () => {
  ...
  test('renders dashboard description', () => {
    ...
    expect(
      screen.getByText(
        /Complete dashboard with sidebar, stats, and content areas/i,
      ),
    ).toBeInTheDocument()
  })
  ...
  test('renders landing page description', () => {
    render(<TemplatesSection onSaveSnippet={mockOnSaveSnippet} />)
    expect(
      screen.getByText(/Marketing page with hero, features, and CTA sections/i),
    ).toBeInTheDocument()
  })
  ...
  test('renders ecommerce description', () => {
    ...
    expect(
      screen.getByText(
        /Product detail page with images, info, and purchase options/i,
      ),
    ).toBeInTheDocument()
  })
  ...
  test('renders blog description', () => {
    render(<TemplatesSection onSaveSnippet={mockOnSaveSnippet} />)
    expect(
      screen.getByText(/Article layout with header, content, and sidebar/i),
    ).toBeInTheDocument()
  })
  ...
  test('component showcase descriptions match templates', () => {
    ...
    expect(
      screen.getByText(
        /Full dashboard template with navigation, sidebar, and stats/i,
      ),
    ).toBeInTheDocument()
    expect(
      screen.getByText(/Full marketing page with hero, features, and CTAs/i),
    ).toBeInTheDocument()
    expect(
      screen.getByText(
        /Product page with images, details, and purchase options/i,
      ),
    ).toBeInTheDocument()
    expect(
      screen.getByText(/Article layout with header, content, and navigation/i),
    ).toBeInTheDocument()
  })
})
