...
export { generateFindingsSummaryTable, getTableStyles, } from './HtmlDetailsSummary.js';
export function generateFindingsSection(findings) {
    ...
    for (const severity of severityOrder) {
        const sFindings = grouped[severity] || [];
...
export function generateRecommendationsSection(recommendations) {
    if (recommendations.length === 0)
        return '';
    let html = '<section class="section"><h2>Recommendations</h2>' +
