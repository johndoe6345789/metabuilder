...
describe('ProfileManager', () => {
  ...
  describe('Built-in Profiles', () => {
    ...
    it('should have correct descriptions for profiles', () => {
      expect(profileManager.getProfile('strict').description).toContain(
        'Enterprise',
      )
      expect(profileManager.getProfile('moderate').description).toContain(
        'Standard',
      )
      expect(profileManager.getProfile('lenient').description).toContain(
        'Development',
      )
    })
  })
