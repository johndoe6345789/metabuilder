...
export function handleListProfiles(): number {
...
export function handleShowProfile(profileName: string): number {
  try {
...
export function handleCreateProfile(profileName: string): number {
  console.log(`\nCreating custom profile: ${profileName}`);
  console.log(
    'This feature requires interactive input. ' +
