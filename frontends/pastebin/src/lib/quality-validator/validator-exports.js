...
export { AnalyzerFactory, } from './analyzers/AnalyzerFactory.js';
...
export { aggregateFindings, deduplicateFindings, deduplicateRecommendations, mergeFindingsArrays, mergeRecommendationsArrays, calculateWeightedScore, scoreToGrade, determineStatus, generateSummary, calculateScoreChange, determineTrend, countFindingsBySeverity, countRecommendationsByPriority, groupFindingsByCategory, sortRecommendationsByPriority, getTopFindings, getTopRecommendations, extractMetricsFromResults, extractFindingsFromResults, extractExecutionTimes, calculateTotalExecutionTime, calculateAverageComponentScore, getScoreExtremes, getCriticalFindings, getLowPriorityFindings, generateMetricsSummary, } from './utils/resultProcessor.js';
