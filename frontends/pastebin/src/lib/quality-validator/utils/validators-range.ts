...
export function validateSecuritySeverity(severity: string): boolean {
  ...
  return (
    ...
    valid.includes(severity.toLowerCase())
  );
}
...
export function validateStatus(status: string): boolean {
  ...
  return (
    typeof status === 'string' && valid.includes(status.toLowerCase())
  );
}
...
export function validatePriority(priority: string): boolean {
  ...
  return (
    ...
    valid.includes(priority.toLowerCase())
  );
}
...
export function validateEffort(effort: string): boolean {
  ...
  return (
    typeof effort === 'string' && valid.includes(effort.toLowerCase())
  );
}
