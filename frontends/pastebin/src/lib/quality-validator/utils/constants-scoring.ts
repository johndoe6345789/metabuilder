...
export const COMPONENT_SCORING_WEIGHTS = {
  COMPLEXITY: 0.4, DUPLICATION: 0.35, LINTING: 0.25,
} as const;

export const COVERAGE_SCORING_WEIGHTS = {
  COVERAGE_PERCENT: 0.6, EFFECTIVENESS: 0.4,
} as const;

export const ARCHITECTURE_SCORING_WEIGHTS = {
  COMPONENTS: 0.35, DEPENDENCIES: 0.35, PATTERNS: 0.3,
} as const;

export const LINTING_IMPACT = {
  ERROR_PENALTY: 10, WARNING_THRESHOLD: 5, WARNING_PENALTY: 2,
} as const;
...
export const DEPENDENCY_IMPACT = {
  CIRCULAR_PENALTY: 20, LAYER_VIOLATION_PENALTY: 10,
} as const;
...
export const REPORT_FORMATS = {
  CONSOLE: 'console', JSON: 'json', HTML: 'html', CSV: 'csv',
} as const;
