...
const mockIndexedDBModule = indexeddbStorage as jest.Mocked<
  typeof indexeddbStorage
>
...
describe('db - Unified Storage Interface', () => {
  ...
  describe('Snippet operations - IndexedDB backend', () => {
    ...
    it('should get snippets by namespace', async () => {
      ...
      expect(result).toEqual(snippets)
      expect(mockIndexedDBModule.getSnippetsByNamespace).toHaveBeenCalledWith(
        'test-ns',
      )
    })
  })
  ...
  describe('Snippet operations - DBAL backend', () => {
    ...
    beforeEach(() => {
      ...
      mockStorageModule.DBALStorageAdapter = jest.fn(
        () => mockDbalAdapter,
      ) as any
    })
  ...
  describe('moveSnippetToNamespace', () => {
    it('should move snippet to new namespace', async () => {
      ...
      const updatedSnippet = (mockIndexedDBModule.updateSnippet as jest.Mock)
        .mock.calls[0][0]
    ...
    it('should throw error if snippet not found', async () => {
      ...
      await expect(
        db.moveSnippetToNamespace('nonexistent', 'new-ns'),
  ...
  describe('Template operations', () => {
    ...
    it('should create template with generated ID and timestamps', async () => {
      ...
      const created = (mockIndexedDBModule.createSnippet as jest.Mock).mock
        .calls[0][0]
  ...
  describe('Namespace operations', () => {
    ...
    it('should delete namespace', async () => {
      ...
      expect(mockIndexedDBModule.deleteNamespace).toHaveBeenCalledWith(
        'default',
      )
    })
  })
  ...
  describe('Database operations', () => {
    ...
    it('should throw error if DBAL connection fails', async () => {
      ...
      await expect(db.initDB()).rejects.toThrow(
        'Failed to connect to DBAL backend',
      )
    })
