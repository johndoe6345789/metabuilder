...
describe('Report Generation', () => {
  ...
  describe('HTML Reporter', () => {
    ...
    it('should include stylesheet', () => {
      const html =
        '<style>body { color: black; } .score { font-weight: bold; }</style>'
    ...
    it('should include score section', () => {
      const html =
        '<section id="score"><h2>Overall Score</h2><p>85.5%</p></section>'
    ...
    it('should include findings section', () => {
      const html =
        '<section id="findings"><h2>Findings</h2><ul><li>Issue 1</li></ul></section>'
