...
describe('FormFieldsSection', () => {
  ...
  describe('Header Section', () => {
    ...
    it('should display description', () => {
      render(<FormFieldsSection onSaveSnippet={mockOnSaveSnippet} />)
      expect(
        screen.getByText('Input fields with labels and helper text'),
      ).toBeInTheDocument()
    })
  ...
  describe('ComponentShowcase', () => {
    ...
    it('should pass correct title to ComponentShowcase', () => {
      render(<FormFieldsSection onSaveSnippet={mockOnSaveSnippet} />)
      expect(
        screen.getByText('Form Field with Icon and Helper Text'),
      ).toBeInTheDocument()
    })
    ...
    it('should pass correct description to ComponentShowcase', () => {
      ...
      expect(
        screen.getByText(
          'Complete form field with label, icon, and validation message',
        ),
      ).toBeInTheDocument()
    })
