    ...
    const report: JsonReport = {
      ...
      codeQuality: {
        complexity: {
          ...
          averagePerFile: 5,
          maximum: 10,
          distribution: { good: 90, warning: 5, critical: 5 },
        },
      ...
      architecture: {
        ...
        patterns: {
          reduxCompliance: { issues: [], score: 95 },
          hookUsage: { issues: [], score: 90 },
          reactBestPractices: { issues: [], score: 85 },
        },
      },
      security: {
        vulnerabilities: [],
...
describe('Quality Validator Types - Error Classes', () => {
  ...
  it('should create AnalysisErrorClass instance', () => {
    const error = new AnalysisErrorClass(
      'Analysis failed',
