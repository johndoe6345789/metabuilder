  ...
  describe('Component Organization Analysis', () => {
    ...
    it('should detect oversized components (>500 lines)', async () => {
      ...
      try {
        ...
        largeComponentCode +=
          'export const LargeComponent = () => <div>Large</div>;'
    ...
    it('should extract correct component name from file path', async () => {
      ...
      try {
        ...
        const metrics = result.metrics as any
        if (metrics.components.oversized.length > 0) {
          expect(metrics.components.oversized[0].name).toBe(
            'MyComplexComponent',
          )
        }
      } finally {
...
import { Button } from './components/Button';
        ...
        const metrics = result.metrics as any
        expect(metrics.dependencies.externalDependencies).toBeDefined()
        expect(metrics.dependencies.externalDependencies instanceof Map).toBe(
          true,
        )
      } finally {
        process.chdir(originalCwd)
  ...
  return A();
    ...
    it('should detect circular dependency in three-module chain A->B->C->A', async () => {
      ...
      try {
        createTestFile(
          tempDir,
          'src/modA.ts',
          "import { B } from './modB'; export const A = B;",
        )
        createTestFile(
          tempDir,
          'src/modB.ts',
          "import { C } from './modC'; export const B = C;",
        )
        createTestFile(
          tempDir,
          'src/modC.ts',
          "import { A } from './modA'; export const C = A;",
        )
    ...
    it('should handle multiple independent modules without circular deps', async () => {
      ...
      try {
        ...
        expect(metrics.dependencies.circularDependencies).toBeDefined()
        expect(
          metrics.dependencies.circularDependencies.length,
...
export const slice = {
  reducer: (state) => {
    state.value = 42;
        ...
        const patternFindings = result.findings.filter(
          f =>
    ...
    it('should reduce score for circular dependencies', async () => {
      ...
      try {
        createTestFile(
          tempDir,
          'src/x.ts',
          "import { Y } from './y'; export const X = Y;",
        )
        createTestFile(
          tempDir,
          'src/y.ts',
          "import { X } from './x'; export const Y = X;",
        )
    ...
    it('should analyze complete project structure', async () => {
      ...
      try {
        ...
        createTestFile(
          tempDir,
          'src/components/molecules/Form.tsx',
          "import { Button } from '../atoms/Button'; export const Form = () => <Button />;",
        )
        createTestFile(
          tempDir,
          'src/components/organisms/Header.tsx',
          "import { Form } from '../molecules/Form'; export const Header = () => <Form />;",
        )
        createTestFile(
          tempDir,
    ...
    it('should handle analysis with multiple violations', async () => {
      ...
      try {
        ...
        createTestFile(
          ...
          'export const reducer = (state) => { state.count = 1; };',
        )
