...
describe('CoverageAnalyzer - Comprehensive Tests (80+ cases)', () => {
  ...
  describe('Coverage Calculation - Lines, Branches, Functions', () => {
    ...
    it('should parse coverage data from JSON', async () => {
      const mockPathExists = jest
        .spyOn(fileSystemModule, 'pathExists')
        .mockReturnValue(true)
      const mockReadJsonFile = jest
        .spyOn(fileSystemModule, 'readJsonFile')
        .mockReturnValue({
          total: {
  ...
  describe('Trend Calculation', () => {
    ...
    it('should track tests with meaningful names', async () => {
      ...
      expect(
        metrics.effectiveness.testsWithMeaningfulNames,
      ).toBeGreaterThanOrEqual(0)
      expect(
        metrics.effectiveness.testsWithMeaningfulNames,
      ).toBeLessThanOrEqual(metrics.effectiveness.totalTests)
    })
    ...
    it('should track average assertions per test', async () => {
      ...
      expect(
        metrics.effectiveness.averageAssertionsPerTest,
      ).toBeGreaterThanOrEqual(0)
    })
    ...
    it('should identify tests without assertions', async () => {
      ...
      expect(
        metrics.effectiveness.testsWithoutAssertions,
      ).toBeGreaterThanOrEqual(0)
    })
    ...
    it('should identify excessively mocked tests', async () => {
      ...
      expect(
        metrics.effectiveness.excessivelyMockedTests,
      ).toBeGreaterThanOrEqual(0)
    })
