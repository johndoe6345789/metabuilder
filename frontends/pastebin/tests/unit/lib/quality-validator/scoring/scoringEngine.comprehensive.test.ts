...
describe('ScoringEngine - Comprehensive Tests (150+ cases)', () => {
  ...
  describe('Score Calculation - Various Metric Combinations', () => {
    ...
    it('should handle high code quality weight', () => {
      const codeQualityWeights: ScoringWeights = {
        codeQuality: 0.7,
        testCoverage: 0.1,
        architecture: 0.1,
        security: 0.1,
      ...
      expect(result.componentScores.codeQuality.weightedScore).toBeGreaterThan(
        0,
      )
    })

    it('should handle high coverage weight', () => {
      const coverageWeights: ScoringWeights = {
        codeQuality: 0.1,
        testCoverage: 0.7,
        architecture: 0.1,
        security: 0.1,
    ...
    it('should handle high security weight', () => {
      const securityWeights: ScoringWeights = {
        codeQuality: 0.1,
        testCoverage: 0.1,
        architecture: 0.1,
        security: 0.7,
    ...
    it('should calculate component scores within 0-100 range', () => {
      ...
      expect(result.componentScores.testCoverage.score).toBeGreaterThanOrEqual(
        0,
      )
    ...
    it('should assign grade A for score >= 90', () => {
      const excellentCodeQuality = createMockCodeQualityMetrics({
        complexity: {
          ...
          averagePerFile: 5,
          maximum: 8,
          distribution: { good: 95, warning: 5, critical: 0 },
        },
      })
    ...
    it('should assign grade B for score >= 80 and < 90', () => {
      const goodCodeQuality = createMockCodeQualityMetrics({
        complexity: {
          ...
          averagePerFile: 10,
          maximum: 15,
          distribution: { good: 75, warning: 20, critical: 5 },
        },
      })
  ...
  describe('Recommendation Generation - All Categories', () => {
    ...
    it('should generate recommendations for low test coverage', () => {
      ...
      const coverageRec = result.recommendations.find(
        r => r.category === 'testCoverage',
      )
    ...
    it('should generate recommendations for oversized components', () => {
      ...
      const compRec = result.recommendations.find(r =>
        r.issue.includes('component'),
      )
    ...
    it('should generate recommendations for critical vulnerabilities', () => {
      ...
      const vulnRec = result.recommendations.find(
    ...
    it('should sort recommendations by priority (critical > high > medium > low)', () => {
      ...
      for (let i = 1; i < result.recommendations.length; i++) {
        const prevPriority =
          priorityOrder[
            result.recommendations[i - 1].priority as keyof typeof priorityOrder
          ]
        const currPriority =
          priorityOrder[
            result.recommendations[i].priority as keyof typeof priorityOrder
          ]
  ...
  describe('Normalization and Weighting', () => {
    ...
    it('should handle zero weights correctly', () => {
      const zeroWeight: ScoringWeights = {
        codeQuality: 0,
        testCoverage: 0.5,
        architecture: 0.5,
        security: 0,
  ...
  describe('Edge Cases - Null, Zero, Max Values, NaN, Infinity', () => {
    ...
    it('should handle maximum values across all metrics', () => {
      const maxCodeQuality = createMockCodeQualityMetrics({
        complexity: {
          ...
          averagePerFile: 100,
          maximum: 200,
          distribution: { good: 1000, warning: 500, critical: 100 },
        },
        duplication: {
          percent: 100,
          lines: 100000,
    ...
    it('should handle negative metric values gracefully', () => {
      const negativeMetrics = createMockCodeQualityMetrics({
        complexity: {
          ...
          averagePerFile: -5,
          maximum: -10,
          distribution: { good: -10, warning: -5, critical: -1 },
        },
      })
    ...
    it('should handle very large metric values', () => {
      const largeMetrics = createMockCodeQualityMetrics({
        complexity: {
          functions: [],
          averagePerFile: 999999,
          maximum: 1000000,
          distribution: { good: 999999, warning: 999999, critical: 999999 },
        },
      })
    ...
    it('should handle extremely small weights', () => {
      const smallWeights: ScoringWeights = {
        codeQuality: 0.00001,
        testCoverage: 0.00001,
        architecture: 0.49999,
        security: 0.49999,
      }
