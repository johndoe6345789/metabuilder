...
import {
  SCORE_THRESHOLDS,
  GRADE_THRESHOLDS,
} from '../../../../../src/lib/quality-validator/utils/constants'
...
function createComponentScores(
  ...
  return {
    codeQuality: {
      score: cqScore,
      weight: weights.cq,
      weightedScore: cqScore * weights.cq,
    },
    testCoverage: {
      score: tcScore,
      weight: weights.tc,
      weightedScore: tcScore * weights.tc,
    },
    architecture: {
      score: archScore,
      weight: weights.arch,
      weightedScore: archScore * weights.arch,
    },
    security: {
      score: secScore,
      weight: weights.sec,
      weightedScore: secScore * weights.sec,
    },
  }
}
