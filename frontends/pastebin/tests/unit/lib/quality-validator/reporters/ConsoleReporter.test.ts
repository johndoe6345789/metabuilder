...
describe('ConsoleReporter', () => {
  ...
  describe('Overall Score Section', () => {
    ...
    it('should show fail status for failing scores', () => {
      ...
      const output = reporter.generate(
        failResult as unknown as ScoringResult,
        false,
      )
  ...
  describe('Findings Section', () => {
    ...
    it('should limit findings display per severity', () => {
      const manyHighSeverity: Finding[] = Array.from(
        { length: 20 },
        (_, i) => ({
          id: `high-${i}`,
  ...
  describe('Trend Section', () => {
    it('should include trend section when trend data exists', () => {
      ...
      const output = reporter.generate(
        resultWithTrend as unknown as ScoringResult,
        false,
      )
    ...
    it('should handle degrading trends', () => {
      ...
      const output = reporter.generate(
        resultDegrading as unknown as ScoringResult,
        false,
      )
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle perfect scores', () => {
      ...
      const output = reporter.generate(
        perfectResult as unknown as ScoringResult,
        false,
      )
    ...
    it('should handle very low scores', () => {
      ...
      const output = reporter.generate(
        lowResult as unknown as ScoringResult,
        false,
      )
