...
describe('useDatabaseOperations Hook', () => {
  beforeEach(() => {
    jest.clearAllMocks()
    // Some tests spyOn document/body with persistent mockReturnValue; restore
    // so a leaked spy can't break a later test (pass-alone-fail-together).
  ...
  describe('loadStats', () => {
    ...
    it('should handle stats loading error', async () => {
      ;(db.getDatabaseStats as jest.Mock).mockRejectedValue(
        new Error('DB Error'),
      )
  ...
  describe('checkSchemaHealth', () => {
    ...
    it('should handle schema check error', async () => {
      ;(db.validateDatabaseSchema as jest.Mock).mockRejectedValue(
  ...
  describe('handleExport', () => {
    ...
    it('should handle export error', async () => {
      ;(db.exportDatabase as jest.Mock).mockRejectedValue(
  ...
  describe('handleImport', () => {
    it('should import database successfully', async () => {
      ...
      mockFile.text = jest.fn().mockResolvedValue('{"snippets": [], "namespaces": []}')
    ...
    it('should handle import error', async () => {
      ;(db.importDatabase as jest.Mock).mockRejectedValue(
  ...
  describe('handleClear', () => {
    ...
    it('should handle clear error', async () => {
      ;(db.clearDatabase as jest.Mock).mockRejectedValue(
