...
/// and audience (DBAL_OIDC_CLIENT_ID, default "pastebin-web"). DBAL is the
/// sole identity provider for this backend -- there is no local password
/// auth or HS256 fallback.
