/**
 * @file index.hpp
 * @brief Main barrel include for all entity operations
 * 
 * Include this file to get access to all entity CRUD operations.
 * Each entity module is namespaced under dbal::entities::{entity_name}
 */
