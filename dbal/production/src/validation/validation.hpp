/**
 * @file validation.hpp
 * @brief Barrel include for all validation functions
 * 
 * Include this header to get all entity validation functions.
 */
#ifndef DBAL_VALIDATION_HPP
#define DBAL_VALIDATION_HPP
