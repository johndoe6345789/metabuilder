            ...
            <div className="space-y-2 flex-1">
              ...
              <div className="space-y-1 text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <code className="px-2 py-0.5 bg-background/50 rounded font-mono font-semibold">{username}</code>
                </div>
                <div className="flex items-center gap-2">
              ...
              <p className={`text-xs font-semibold mt-2 ${
                isSupergod ? 'text-amber-600 dark:text-amber-400' : 'text-orange-600 dark:text-orange-400'
              }`}>
                {isSupergod 
