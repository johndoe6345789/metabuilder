 ...
 * Provides backward-compatible interface with original useProjectCanvas
 */

import { useCanvasZoom, UseCanvasZoomReturn } from './useCanvasZoom';
import { useCanvasPan, UseCanvasPanReturn } from './useCanvasPan';
import { useCanvasSelection, UseCanvasSelectionReturn } from './useCanvasSelection';
import { useCanvasItems, UseCanvasItemsReturn } from './useCanvasItems';
import { useCanvasSettings, UseCanvasSettingsReturn } from './useCanvasSettings';
import { useCanvasItemsOperations, UseCanvasItemsOperationsReturn } from './useCanvasItemsOperations';
import { useCanvasGridUtils, UseCanvasGridUtilsReturn } from './useCanvasGridUtils';
