-- Metadata validation tests for ui_level4 package
-- Uses lua_test framework

describe("Level 4 Admin Panel Package Metadata", function()
  ...
  it("should have valid package structure", function()
    ...
    expect(metadata.name).toBe("Level 4 - Admin Panel")
  ...
  it("should require minLevel 4", function()
    expect(metadata.minLevel).toBe(4)
  end)
