-- Metadata validation tests for ui_level3 package
-- Uses lua_test framework

describe("Level 3 Moderator Panel Package Metadata", function()
  ...
  it("should have valid package structure", function()
    ...
    expect(metadata.name).toBe("Level 3 - Moderator Panel")
  ...
  it("should require minLevel 3", function()
