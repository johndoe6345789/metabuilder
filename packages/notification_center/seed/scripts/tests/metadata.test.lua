-- Metadata validation tests for notification_center package
-- Uses lua_test framework

describe("Notification Center Package Metadata", function()
  ...
  it("should export NotificationSummary component", function()
    local components = metadata.exports.components
    local found = false
    for _, c in ipairs(components) do
      if c == "NotificationSummary" then found = true break end
    end
