...
Rectangle {
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            CText {
                text: "God Panel"; font.pixelSize: 28; font.weight: Font.Bold
                font.letterSpacing: -0.5; color: root.onSurface
            }
            CBadge { text: "Level 4"; variant: "primary" }
            CStatusBadge { status: "success"; text: "Active" }
            Item { Layout.fillWidth: true }
            CButton { text: "Level 1"; variant: "ghost"; size: "sm"; onClicked: root.navigateLevel(1) }
            CButton { text: "Level 2"; variant: "ghost"; size: "sm"; onClicked: root.navigateLevel(2) }
            CButton { text: "Level 3"; variant: "ghost"; size: "sm"; onClicked: root.navigateLevel(3) }
        }
        Flow {
