    ...
    ScrollView {
        ...
        ColumnLayout {
            ...
            GridLayout {
                ...
                Repeater {
                    model: [
                        ...
                        { label: "Memory", value: root.systemMetrics.memory },
                        { label: "Disk", value: root.systemMetrics.disk },
                        { label: "Network", value: root.systemMetrics.network }
                    ]
            ...
            FlexRow {
                ...
                CButton { text: "Clear Cache"; variant: "ghost"; size: "sm"; onClicked: root.clearCacheRequested() }
