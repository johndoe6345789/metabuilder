        ...
        RowLayout {
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    RowLayout { Layout.fillWidth: true; spacing: 10; CText { text: "Theme Editor"; font.pixelSize: 16; font.weight: Font.DemiBold; color: onSurface } CChip { text: "Visual"; chipColor: Theme.info } }
            ...
            Rectangle {
                ...
                ColumnLayout {
                    anchors.fill: parent; anchors.margins: 20; spacing: 12
                    RowLayout { Layout.fillWidth: true; spacing: 10; CText { text: "SMTP Configuration"; font.pixelSize: 16; font.weight: Font.DemiBold; color: onSurface } CChip { text: "Email"; chipColor: Theme.primary } }
                    Rectangle { Layout.fillWidth: true; height: 1; color: outlineVariant }
