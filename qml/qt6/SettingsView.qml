...
import "../MetaBuilder/SettingsLogic.js" as Logic
...
Rectangle {
    ...
    property alias profileSavedTimer: _profileSavedTimer

    Component.onCompleted: { if (useLiveData) Logic.loadPreferences(root, dbal) }
    onUseLiveDataChanged: { if (useLiveData) Logic.loadPreferences(root, dbal) }
    Timer { id: _profileSavedTimer; interval: 3000; onTriggered: profileSaved = false }
        ...
        ColumnLayout {
            ...
            CSettingsSection {
                ...
                FlexRow {
                    ...
                    CAvatar { size: "lg"; initials: Logic.userInitials(appWindow.currentUser) }
                    ColumnLayout {
                ...
                FlexRow {
                    ...
                    CButton { text: "Save Profile"; variant: "primary"; onClicked: Logic.saveProfile(root, dbal) }
                }
            }
            ...
            CSettingsSection {
                ...
                CThemePicker {
                    ...
                    onThemeSelected: function(name) { root.selectedTheme = name; appWindow.currentTheme = name; if (typeof Theme.setTheme === "function") Theme.setTheme(name); Logic.savePreferences(root, dbal) }
                }
                ...
                FlexRow {
                    ...
                    Repeater {
                        ...
                        delegate: CButton { text: modelData.label; variant: fontSize === modelData.id ? "primary" : "default"; size: "sm"; onClicked: { fontSize = modelData.id; Logic.savePreferences(root, dbal) } }
                    }
                }
            }
            ...
            CSettingsSection {
                ...
                CNotificationToggles {
                    ...
                    onToggled: function(id, value) { var nv = JSON.parse(JSON.stringify(notifValues)); nv[id] = value; notifValues = nv; Logic.savePreferences(root, dbal) }
                }
            }

            CSettingsSection { title: "Connection"; CConnectionTest { Layout.fillWidth: true } }

            CSettingsSection {
                title: "About"
                Repeater {
                    model: aboutConfig
                    delegate: FlexRow { Layout.fillWidth: true; spacing: 12; CText { variant: "body2"; text: modelData.label; opacity: 0.6; Layout.preferredWidth: 120 }; CText { variant: "body1"; text: modelData.value } }
                }
                FlexRow { Layout.fillWidth: true; spacing: 12; CText { variant: "body2"; text: "Platform"; opacity: 0.6; Layout.preferredWidth: 120 }; CText { variant: "body1"; text: Qt.platform.os } }
